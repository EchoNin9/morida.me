...
def _patch_boto3():
    ...
    with patch.dict(os.environ, {
        "TABLE_NAME": "mo-main-test",
        "MEDIA_BUCKET": "mo-media-test",
        "COGNITO_USER_POOL_ID": "us-west-2_TESTPOOL",
        "THUMB_FUNCTION_NAME": "mo-thumb-test",
    }):
...
class TestShows:
    def test_shmo_get(self, _patch_boto3):
        handler = _patch_boto3
