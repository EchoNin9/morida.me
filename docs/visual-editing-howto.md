# Visual Editing Guide for morida.me

How to make visual changes to the MoRida website using Cursor's browser preview.
...
Edit `src/web/spa/src/features/press/PressPage.tsx` — search for `band@morida.me` and `src/web/spa/src/shell/Footer.tsx`.
