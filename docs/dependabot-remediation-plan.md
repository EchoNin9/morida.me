...
This document is the **canonical plan** for resolving Dependabot security and version-update warnings in morida.me. Use it when Dependabot fixes cannot be completed in one session.
