...
output "cloudfrontStagingDomain" {
  description = "CloudFront distribution domain name for staging (target for ClouDNS CNAME/ALIAS)."
  value       = aws_cloudfront_distribution.staging.domain_name
}

output "cloudfrontProductionDomain" {
  description = "CloudFront distribution domain name for production (target for ClouDNS CNAME/ALIAS)."
...
output "acmValidationCnameNames" {
  description = "ACM DNS validation record names — add these as CNAMEs in ClouDNS."
...
output "acmValidationCnameValues" {
  description = "ACM DNS validation record values — add these as CNAME targets in ClouDNS."
